---
title: 'Upgraded My Portfolio to Next.js 16.3: This Is What I Learned'
description: 'Measured before-and-after numbers from moving a Next.js portfolio and blog from 15 to 16: build times 2.5x faster, dev server boot 3.6x faster, and the two changes you need to make first.'
...
_Measured on this site: a Next.js App Router portfolio with 14 MDX posts, Tailwind v4, and no test suite. Your numbers will differ, but the shape of the win, faster builds and a much faster dev loop, should hold._
