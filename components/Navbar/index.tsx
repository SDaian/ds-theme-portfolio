...
const Navbar = () => {
  ...
  return (
    ...
    //   </div>
    // </header>
    <header className='py-1 px-5 sm:px-20 flex flex-col md:flex-row items-center fixed top-0 w-full justify-between z-40 shadow backdrop-blur-md dark:shadow-slate-500'>
      <div className='flex flex-grow sm:basis-0 basis-full w-full'>
        <Logo navbar={navbar} setNavbar={setNavbar} />
      </div>
